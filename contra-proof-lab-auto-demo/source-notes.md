...
In this public demo, the form only updates the on-page owner summary and confirmation message. The current layout follows the original Template 2 mockup direction: navy utility band, white header, wide repair-bay hero image, quote card, workflow rail, service chips, and demo-safe trust strip.
